								...
								<div className="flex-auto p-4">
									<div className="flex flex-wrap">
										<div className=" w-full pr-4 max-w-full flex-grow flex-auto">
											<span className="flex justify-center uppercase text-blue-400 hover:text-blue-600 mr-0 whitespace-no-wrap text-3xl font-bold p-4 px-0">
												Create a new class
											</span>
										</div>
									</div>
									<div class="flex flex-col px-80 mt-6 mb-4">
										<label class="flex flex-col justify-center">
											...
											<input
												...
												class="form-input mt-2 block focus:border-blue-400 rounded"
										...
										<button
											class="mt-6 flex flex-col items-center px-2 py-4 rounded text-white cursor-pointer bg-blue-400 hover:bg-blue-600 focus:border-white"
