				...
				<div className="relative bg-gradient-to-r from-gray-800 to-blue-300 md:pt-32 pb-32 pt-12 rounded-2xl">
					<div className="w-full pr-4 mb-16 max-w-full flex-grow flex-auto">
						...
						<span className="flex justify-center text-white mr-0 whitespace-no-wrap text-sm pt-2">
							All the Classes will be shown here
						</span>
					</div>
											...
											<div className="relative w-full pr-4 max-w-full flex-grow flex-1">
												...
												<p className="mt-8">
													{generatedCode.courseID === course._id ? null : (
														<button
															className="bg-blue-400 text-white rounded p-2 font-bold text-base transition duration-300 hover:bg-blue-600"
														...
														<div class="flex text-center flex-col items-center justify-center mt-6 mb-4">
															<label class="flex flex-col mt-6">
																...
																<input
																	type="text"
																	readOnly
																	class="form-input mt-4 text-center focus:border-blue-400 rounded"
																	value={generatedCode.attendanceCode}
																/>
															</label>

															<label class="flex flex-col items-center px-4 py-6 mt-2 rounded text-gray-600 border border-gray-500 cursor-pointer hover:text-sky-600 hover:border-sky-600">
																<svg
																	class="w-8 h-8"
																	fill="none"
																	stroke="currentColor"
															...
															<button
																class="mt-6 flex flex-col items-center px-2 py-4 rounded text-white cursor-pointer bg-blue-400 transition duration-300 hover:text-yellow-400 focus:border-white"
