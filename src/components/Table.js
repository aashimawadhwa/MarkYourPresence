		...
		<>
			<div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard rounded">
				<table class="min-w-full">
					<thead>
						<tr>
							<th class="px-6 py-3 border-b-2 border-gray-900 text-left text-base font-bold leading-4 text-sky=800 tracking-wider">
								ID
							</th>
							<th class="px-6 py-3 border-b-2 border-gray-900 text-left text-base font-bold leading-4 text-sky=800 tracking-wider">
								Course
						...
						{props.data.map((course, index) => (
							<tr>
								...
								<td class="pr-4 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
									<button
										class="px-6 py-2 border-blue-400 border text-blue-400 rounded transition duration-300 hover:bg-blue-400 hover:text-white focus:outline-none"
